...
*txt2onto 2.0* is a Python utility for classifying unstructured description of sample and study to controlled vocabularies in tissue and disease ontologies – a combination of natural language processing (NLP) and machine learning (ML). In this repo, we provide trained models which can be directly used for tissue and disease annoatation. We also provide demo script to train models from user provide metadata.
...
# Usage
## Making prediction using provided models
